  ...
  const handleSubmitAccount = async () => {
    ...
    try {
      ...
      const accountData = {
        ...
        customer_role: "OWNER",
        product_account: isPublic ? "SAVE.ACCT.ONLINE" : (selectedCategory?.lookupCode || "SAVE.ACCT.ONLINE"),
        account_type: isPublic ? "SAVE.ACCT.ONLINE" : (selectedCategory?.lookupCode || "SAVE.ACCT.ONLINE"),
      };
