...
public final class AppConstants {
        ...
        // ==================================================================================
        public static final String AML_NEED_REVIEW_MSG = "ការស្នើសុំបង្កើតគណនីរបស់អ្នកកំពុងស្ថិតក្នុងការពិនិត្យ។ បន្ទាប់ពីការពិនិត្យត្រូវបានអនុម័ត ធនាគារនឹងផ្ញើសារទូរស័ព្ទ (SMS) ជូនដំណឹងដល់លោកអ្នក ឬទំនាក់ទំនងសេវាបម្រើអតិថិជន 070 200 002 ឬ 1800 200 888 ដើម្បីជំនួយបន្ថែម។";
        public static final String AML_REJECTED_MSG = "ការស្នើសុំបង្កើតគណនីមិនត្រូវបានអនុម័តសម្រាប់អត្តសញ្ញាណប័ណ្ណលេខ %s។ "
                        + SUPPORT_CONTACT;
        public static final String AML_UNKNOWN_MSG = "ការស្នើសុំបង្កើតគណនីសម្រាប់អត្តសញ្ញាណប័ណ្ណលេខ %s កំពុងដំណើរការ។ សូមព្យាយាមម្តងទៀតនៅពេលក្រោយ ឬទំនាក់ទំនងសេវាបម្រើអតិថិជនតាមរយៈលេខ "
