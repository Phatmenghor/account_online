...
public interface JuniorAccountMapper {
    ...
    @Mapping(target = "customerProvince", source = "request.customerProvinceKh")
    @Mapping(target = "customerDistrict", source = "request.customerDistrictKh")
    @Mapping(target = "customerCommune", source = "request.customerCommuneKh")
    @Mapping(target = "customerVillage", source = "request.customerVillageKh")
    ...
    @Mapping(target = "customerPobProvince", source = "request.customerPobProvinceKh")
    @Mapping(target = "customerPobDistrict", source = "request.customerPobDistrictKh")
    @Mapping(target = "customerPobCommune", source = "request.customerPobCommuneKh")
    @Mapping(target = "customerPobVillage", source = "request.customerPobVillageKh")
